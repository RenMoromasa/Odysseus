...
exports.Fonts = exports.Colors = exports.FontSizes = exports.Radii = exports.Spacing = exports.TagColors = exports.AppColors = void 0;
...
exports.Colors = {
    light: {
        text: exports.AppColors.light.text,
        background: exports.AppColors.light.background,
        tint: tintColorLight,
        icon: exports.AppColors.light.textMuted,
        tabIconDefault: exports.AppColors.light.textMuted,
        tabIconSelected: tintColorLight,
    },
    dark: {
        text: exports.AppColors.dark.text,
        background: exports.AppColors.dark.background,
        tint: tintColorDark,
        icon: exports.AppColors.dark.textMuted,
        tabIconDefault: exports.AppColors.dark.textMuted,
